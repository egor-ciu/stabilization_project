...
Это и есть **P**-регулятор. Например, если заданы крен = $\large 0°$, тангаж = $\large 30°$, то оба двигателя будут делать смещение вниз. Если крен = $\large 30°$, тангаж = $\large 0°$, то первый двигатель делает смещение вверх, второй двигатель делает смещение вниз. 
...
Начальные данные: крен = $30°$, тангаж = $30°$.
...
![hjhj](крен = 30, тангаж = 30, крен.png)
